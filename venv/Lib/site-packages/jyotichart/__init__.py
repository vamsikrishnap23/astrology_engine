...
def create_chartSVG_nc(chartObj,location,chartSVGfilename):
    ...
    chartSVG.write('  <style>\n')
    chartSVG.write('    .sign-num { font-size: 22px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .planet { font-size: 20px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .aspect { font-size: 22px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('  </style>\n')
    chartSVG.write('  <!-- ********** Chart Diagram ********** -->\n')
...
def create_transitchartSVG(chartObj,location,chartSVGfilename, parentChartObj):
    ...
    chartSVG.write('  <style>\n')
    chartSVG.write('    .sign-num { font-size: 22px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .natal-planet { font-size: 20px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .natal-aspect { font-size: 22px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .transit-planet { font-size: 20px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('    .transit-aspect { font-size: 22px; font-weight: bold; font-family: sans-serif; }\n')
    chartSVG.write('  </style>\n')
    chartSVG.write('  <!-- ********** Chart Diagram ********** -->\n')
